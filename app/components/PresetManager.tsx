...
import { Save, Trash2, Upload,ImportIcon } from "lucide-react";
  ...
  function deletePreset(id: string, name: string) {
    Modal.confirm({
      ...
      onOk: () => {
        ...
        toast.error(`Preset "${name}" deleted`);
      },
    });
  }
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2 ml-4">
                    ...
                    {appliedPresetId === preset.id ? (
                      <button
                        disabled
                        className="px-2 py-2 bg-green-600 text-white rounded-lg  cursor-default flex items-center gap-1"
